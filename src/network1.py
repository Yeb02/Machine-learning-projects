...
class Network(object):
    ...
    def evaluate(self, test_data):
        ...
        print(test_results[0][0], '= trouvé', test_results[0][1], '= attendu')  #n'utiliser que pour lecteur_data.
        # return sum(int(x == y) for (x, y) in test_results)    # Nécessaire pour l'évaluation lors de l'entrainement
                                                                # et donc du choix des hypers paramètres.
...
net.SGD(training_data, 25, 11, 3.0, test_data=test_data)
